...
void GraphicsView::mouseReleaseEvent(QMouseEvent *event)
{
    ...
    case DefaultMouseContext:
        if(event->button() == Qt::LeftButton)
        {
            ...
            {
                RTLSControllerApplication::anchorSelectionModel()->clearSelection();
            }
        }
        break;
    }
...
void GraphicsView::drawGrid(QPainter *painter, const QRectF &rect)
{
    ...
    double width  = RTLSControllerApplication::viewSettings()->gridWidth();
    double height = RTLSControllerApplication::viewSettings()->gridHeight();
...
void GraphicsView::drawBackground(QPainter *painter, const QRectF &rect)
{
    ...
    if(RTLSControllerApplication::viewSettings()->gridShow()) //draw grip if show grid is set
        drawGrid(painter, rect);

    if(RTLSControllerApplication::viewSettings()->originShow()) //draw origin if show origin is set
        drawOrigin(painter);
